...
MethodName :
    IDENTIFIER                          { printf("[%s] MethodName.\n", yylval.buffer); }
    ;
...
TypeSwitchGuard :
    ...
    | IDENTIFIER ":=" PrimaryExpr '.' '(' TYPE ')'                      { printf("[%s] TypeSwitchGuard - Identifier := PrimaryExpr . ( Type ).\n", yylval.buffer); }
    ;
...
AliasDecl :
    IDENTIFIER '=' Type                                         { printf("[%s] AliasDecl.\n", yylval.buffer); }
    ;
...
FunctionName :
	IDENTIFIER	                                            { printf("[%s] FunctionName.\n", yylval.buffer); }
	;
